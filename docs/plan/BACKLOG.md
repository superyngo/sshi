...
|---|---|---|
| B41 | `fetch_latest_snapshots` read the whole snapshot history | HASH-B41 — `latest_snapshot_sql` window query (newest `collected_at`, then `id`); tests: 15 history rows → 2, missing host kept |
