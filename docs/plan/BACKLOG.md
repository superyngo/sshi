...
|---|---|---|
| B59 | PowerShell swap collected but never displayable | HASH-B59 — `parser::parse_ps_swap` + shared `ps_swap_totals` used by `extract_metric_value` (legacy raw snapshots too); tests |
